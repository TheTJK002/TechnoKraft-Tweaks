...
public class ModBlockCreate {
    ...
    public static final RegistryObject<Block> COPPER_MACHINE = registerBlock("copper_machine", () -> new Block(BlockBehaviour.Properties.of(Material.METAL).requiresCorrectToolForDrops().strength(0.6f).noOcclusion()), ModCreativeTabs.TECHNOKRAFTTWEAKS);
