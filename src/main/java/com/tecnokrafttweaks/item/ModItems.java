...
public class ModItems {
    ...
    public static final RegistryObject<Item> SAND_CHUNKS = ITEMS.register("sand_chunks", () -> new Item(new Item.Properties().stacksTo(1).tab(ModCreativeTabs.TECHNOKRAFTTWEAKS)));
    ...
    public static final RegistryObject<Item> FLINT_SAW = ITEMS.register("flint_saw", () -> new Item(new Item.Properties().stacksTo(1).tab(ModCreativeTabs.TECHNOKRAFTTWEAKS)));
    public static final RegistryObject<Item> IRON_SAW = ITEMS.register("iron_saw", () -> new Item(new Item.Properties().stacksTo(1).tab(ModCreativeTabs.TECHNOKRAFTTWEAKS)));
    public static final RegistryObject<Item> DIAMOND_SAW = ITEMS.register("diamond_saw", () -> new Item(new Item.Properties().stacksTo(1).tab(ModCreativeTabs.TECHNOKRAFTTWEAKS)));
